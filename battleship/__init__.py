...
# some sort of update or on_button_press that constantly checks for when a button is pressed
# -when button is pressed calls move ship function and passes in correct ship


# move ship (ship)
# -draws ship following cursor
# -rotates based on key press
