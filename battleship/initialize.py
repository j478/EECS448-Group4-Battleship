...
class Initialize:
    ...
    def __init__(self, win, ChooseGameSize, GameSize,active,ai):
        ...
        #AI buttons
        #self.m1 = Button((0, 250, 0),...'Player Mode')
        #self.m2 = Button((0, 250, 0),...'CPU Mode')
        
        #self.d1 = Button((0, 250, 0),...'Easy Mode')
        #self.d2 = Button((0, 250, 0),...'Medium Mode')
        #self.d3 = Button((0, 250, 0),...'Hard Mode')
